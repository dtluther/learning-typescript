...
const x = 'One';
const y = new Promise((resolve, _) => resolve("Two"));
const z = new Promise((_, reject) => reject(new Error("Three")));
function gilad() {
    return __awaiter(this, void 0, void 0, function* () {
        const four = yield x; // setTimeout(() => {}, 0), so still async but goes straight to callback queue
        console.log({ x: four });
        const five = yield y;
        console.log({ y: five });
        try {
